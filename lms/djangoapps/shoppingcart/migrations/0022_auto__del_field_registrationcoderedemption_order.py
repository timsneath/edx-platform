...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'RegistrationCodeRedemption.order'
        db.delete_column('shoppingcart_registrationcoderedemption', 'order_id')


    def backwards(self, orm):
        # Adding field 'RegistrationCodeRedemption.order'
        db.add_column('shoppingcart_registrationcoderedemption', 'order',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['shoppingcart.Order'], null=True),
                      keep_default=False)
    ...
    models = {
        ...
        'shoppingcart.coupon': {
            ...
            'created_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 12, 9, 0, 0)'}),
        ...
        'shoppingcart.registrationcoderedemption': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'redeemed_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 12, 9, 0, 0)', 'null': 'True'}),
